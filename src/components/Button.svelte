...
<button
	class="relative inline-flex items-center px-6 py-4 border-2 border-white text-sm text-white leading-none uppercase select-none overflow-hidden transition duration-300 hover:text-black"
	style:width
	style:height
